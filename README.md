...
当前版本：**2.0.11**，推荐配合萌卡 NT **2.1.8 或更新版本** 使用。本版优化首页加载及菜单切换，提供一键同域用户门户和托管热重启，修复反向代理注册登录的来源误判；配套框架同时修复更新重启导致插件不可达的问题。详细变更与升级说明见 [v2.0.11 版本说明](release-notes-v2.0.11.md)。
